...
#Region "Attributes"
    ...
    Private mAdultPricePerUnit As Decimal
    Private mChildPricePerUnit As Decimal
...
#Region "Constructors"
    ...
    Public Sub New(
        ...
        _AdultPricePerUnit = pAdultPricePerUnit
        _ChildPricePerUnit = pChildPricePerUnit
...
#Region "Get/Set Methods"
    ...
    Public Property AdultPricePerUnit As Decimal
        Get
            Return _AdultPricePerUnit()
        End Get
        Set(pValue As Decimal)
            _AdultPricePerUnit() = pValue
        End Set
    End Property

    Public Property ChildPricePerUnit As Decimal
        Get
            Return _ChildPricePerUnit()
        End Get
        Set(pValue As Decimal)
            _ChildPricePerUnit() = pValue
        End Set
    End Property
    ...
    Private Property _AdultPricePerUnit() As Decimal
        Get
            Return mAdultPricePerUnit
        End Get
        Set(ByVal pValue As Decimal)
            mAdultPricePerUnit = pValue
        End Set
    End Property

    Private Property _ChildPricePerUnit() As Decimal
        Get
            Return mChildPricePerUnit
        End Get
        Set(ByVal pValue As Decimal)
            mChildPricePerUnit = pValue
        End Set
    End Property
...
#Region "Behavioral Methods"
    ...
    Private Function _toString() As String
        ...
        tmpStr = vbCrLf & "Feature ID: " & mId & vbCrLf _
            & "Name: " & mName & vbCrLf _
            & "Unit Of Measure: " & mUnitOfMeasure & vbCrLf _
            & "Adult Price: " & mAdultPricePerUnit & vbCrLf _
            & "Child Price: " & mChildPricePerUnit
