...
#Region "Attributes"
    ...
    Private mQuantity As Decimal
    Private mPrice As Decimal
    'Private mQuantityRemaining As Decimal
...
#Region "Get/Set Methods"
    ...
    Public Property Price As Decimal
        ...
        End Set
    End Property
    Public Property Passport As Passport
        Get
            Return _Passport()
        End Get
        Set(pValue As Passport)
            _Passport() = pValue
        End Set
    End Property
    ...
    Private Property _Quantity() As Decimal
        Get
            Return mQuantity
        End Get
    ...
    Private Property _Price() As Decimal
        Get
            Return mPrice
        End Get
        Set(ByVal pValue As Decimal)
    ...
    'Private Property _QuantityRemaining() As Decimal
    '    Get
    '        Return mQuantityRemaining
    '    End Get
    '    Set(ByVal pValue As Decimal)
    '        mQuantityRemaining = pValue
    '    End Set
    'End Property
...
#Region "Behavioral Methods"
    ...
    Private Function _toString() As String
        ...
        tmpStr = vbCrLf _
            & "ID: " & mId & vbCrLf _
            & "QuantityPurchased: " & mQuantity & vbCrLf _
            & "Price: " & mPrice & vbCrLf & vbCrLf _
            & "(PASSED OBJECT) Passport: " & mPassport.ToString & vbCrLf & vbCrLf _
            & "(PASSED OBJECT) Feature: " & mFeature.ToString & vbCrLf
        ' & "QuantityRemaining: " & mQuantityRemaining & vbCrLf _
